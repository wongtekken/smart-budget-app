...
export const DEFAULT_BUDGET_TEMPLATES: DefaultBudgetTemplate[] = [
  {
    ...
    isDefault: true,
    allocations: [
      { categoryName: "Housing", mode: "Percentage", value: 30 },
      { categoryName: "Groceries", mode: "Percentage", value: 15 },
      { categoryName: "Food & Drinks", mode: "Percentage", value: 12 },
      { categoryName: "Transport", mode: "Percentage", value: 10 },
      { categoryName: "Utilities", mode: "Percentage", value: 8 },
      { categoryName: "Health", mode: "Percentage", value: 7 },
      { categoryName: "Personal Care", mode: "Percentage", value: 5 },
      { categoryName: "Entertainment", mode: "Percentage", value: 5 },
      { categoryName: "Other", mode: "Percentage", value: 8 },
    ],
  },
];
